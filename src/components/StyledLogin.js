...
export default function LoginScreen({ onLogin }) {
  ...
  const roles = [
    ['landlord', '🏢', 'Landlord', 'Manage your building'],
    ['tenant', '🛍️', 'Tenant', 'Run your shop'],
    ['superadmin', '🛡️', 'Superadmin', 'Manage the platform'],
  ];
      ...
      <div className="bg-white p-[40px_32px] flex flex-col justify-center">
        ...
        <div className="flex gap-[12px] mb-[24px]">
          {roles.map(([r, ic, lbl, sub]) => (
            ...
            >
              <div className="text-[20px] mb-[6px]">{ic}</div>
        ...
        <div className="mb-[20px]">
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute right-[12px] top-[12px] bg-transparent border-none text-[14px] text-ink-400 cursor-pointer"
            >
              👁
            </button>
          </div>
        ...
        <button
          onClick={attempt}
          className="w-full bg-forest-500 text-white font-sans font-bold text-[14px] p-[14px] rounded-[10px] border-none cursor-pointer hover:bg-forest-700 transition-colors shadow-[0_4px_12px_rgba(139,92,246,0.3)]"
        >
          Sign in to yoMall →
        </button>
      </div>
