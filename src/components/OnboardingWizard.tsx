...
import { Check, Banknote, Wallet } from 'lucide-react';
        ...
        {step === 2 && (
          <div className="ob-step-panel active">
            ...
            <div className="ob-plan-grid">
              ...
              >
                <div className="mo-ic" style={{ display: 'flex' }}><Banknote size={16} /></div>
                <div>
                  <div className="mo-name">Rent advance</div>
                  <div className="mo-sub">Monthly advance &rarr; daily/weekly repayments</div>
                </div>
              ...
              >
                <div className="mo-ic" style={{ display: 'flex' }}><Wallet size={16} /></div>
                <div>
