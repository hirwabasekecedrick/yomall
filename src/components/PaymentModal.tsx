...
import { Smartphone, CircleDot, Delete, Check, ArrowLeft, X } from 'lucide-react';
        ...
        <div className={`pm-step${step === 1 ? ' active' : ''}`}>
          ...
          <div className="pm-body">
            ...
            <div className="pm-summary" style={{ gap: '10px' }}>
              ...
              >
                <span className="mo-ic" style={{ display: 'flex' }}><Smartphone size={16} /></span>
                <div>
                  <div className="mo-name">MoMo</div>
                  <div className="mo-sub">MTN Mobile Money</div>
                </div>
                {method === 'momo' && <span className="mo-check"><Check size={12} /></span>}
              </button>
              <button
                className={`method-opt${method === 'airtel' ? ' selected' : ''}`}
                onClick={() => setMethod('airtel')}
              >
                <span className="mo-ic" style={{ display: 'flex', color: '#D64545' }}><CircleDot size={16} /></span>
                <div>
                  <div className="mo-name">Airtel Money</div>
                  <div className="mo-sub">Airtel Rwanda</div>
                </div>
                {method === 'airtel' && <span className="mo-check"><Check size={12} /></span>}
              </button>
            </div>
